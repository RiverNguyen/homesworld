...
// icon nhiệt độ
export function ThermometerIcon({ className = '', ...props }: IconProps) {
  return (
    <svg
...
export function VerticalDashLine({ className = '', ...props }: IconProps) {
  return (
    <svg
      viewBox='0 0 1 122'
      fill='none'
...
// icon dọc
export function ICVerticalDashedLine(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      viewBox='0 0 1 122'
      fill='none'
...
// line mobile
export function ICHorizontalDashedLine(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      viewBox='0 0 311 1'
      fill='none'
  ...
  return (
    <div className='absolute bottom-[2.5rem] z-50 left-[2.5rem] flex flex-col xsm:bottom-[1.25rem] xsm:left-[1rem] xsm:right-[1rem] xsm:px-[1.25rem]'>
      <div className='flex items-end justify-start xsm:items-center'>
        ...
        <VerticalDashLine className='mx-[1.5rem] h-[7.625rem] w-[0.0625rem] text-white xsm:hidden' />
