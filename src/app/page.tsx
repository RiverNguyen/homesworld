...
export default async function HomePage() {
  const [homeData, blogRes, taxonomiesData] = await Promise.all([homeService.getHome(), homeService.getBlogs({ limit: 5 }), taxonomiesService.getAllTaxonomies('service_combo')])
  return (
    <>
