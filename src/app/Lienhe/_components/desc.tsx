...
const Desc = () => {
  ...
  return (
    <div className='contact__left flex flex-col  xsm:w-[100%] '>
          ...
          >
            {socialData.map((item, index) => (
              <SwiperSlide key={index}>
                <div className='relative w-[7.5625rem] h-[7.5625rem] flex flex-col items-center justify-center xsm:w-[6.8125rem] xsm:h-[6.8125rem]'>
                  <img
                    src={item.image}
                    alt={item.text}
                    className='w-[7.5625rem] h-[7.5625rem] object-cover rounded-xl  xsm:w-[6.8125rem] xsm:h-[6.8125rem]'
                  />
