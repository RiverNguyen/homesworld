  ...
  return (
    <div className='pointer-events-none'>
      ...
      <div
        ...
        className='w-[87.5rem] bg-white pt-[2.1875rem] max-h-[30.38rem] pointer-events-auto pr-[0.62rem] mx-auto rounded-[1.125rem] shadow-[0.125rem_0.375rem_2rem_0rem_rgba(0,0,0,0.06)] overflow-hidden'
      >
        <div
